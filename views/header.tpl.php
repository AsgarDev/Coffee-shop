      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            <li class="nav-item <?= $currentPage == 'home' ? 'active' : '' ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href=".">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item px-lg-4 <?= $currentPage == 'products' ? 'active' : '' ?>">
              <a class="nav-link text-uppercase text-expanded" href="./products">Products</a>
            </li>
            <li class="nav-item px-lg-4 <?= $currentPage == 'store' ? 'active' : '' ?>">
